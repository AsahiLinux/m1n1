...
class Start3DStruct1(ConstructClass):
    subcon = Struct(
        ...
        "unk_380" / Int64ul,
        "unk_388" / Int64ul,
        Ver("V >= V12_6_1", "unk_390_0" / Int64ul),
...
class Start3DCmd(ConstructClass):
    subcon = Struct( # 0x194 bytes''''
        ...
        "unk_190" / Int32ul,
        Ver("V >= V12_6_1", "unk_194" / Int64ul),
        Ver("V >= V12_6_1", "unkptr_19c" / Int64ul),
    )
...
class Finalize3DCmd(ConstructClass):
    subcon = Struct( # 0x9c bytes
        ...
        "unk_98" / Int32ul, # 1
        Ver("V >= V12_6_1", "unk_9c" / HexDump(Bytes(0x10))),
    )
...
class StartTACmd(ConstructClass):
    subcon = Struct(
        ...
        "unk_170" / Int64ul,
        "unk_178" / Int32ul,
        Ver("V >= V12_6_1", "unk_17c" / Int32ul),
        Ver("V >= V12_6_1", "unkptr_180" / Int64ul),
        Ver("V >= V12_6_1", "unk_188" / Int32ul),
    )
...
class FinalizeTACmd(ConstructClass):
    subcon = Struct(
        ...
        "restart_branch_offset" / Int32sl,
        "unk_70" / Int32ul,
        Ver("V >= V12_6_1", "unk_74" / HexDump(Bytes(0x10))),
    )
...
class TimestampCmd(ConstructClass):
    subcon = Struct( # 0x34 bytes
        ...
        "cmdqueue_ptr" / Int64ul,
        "unk_24" / Int64ul,
        Ver("V >= V12_6_1", "unkptr_2c_0" / Int64ul),
        "uuid" / Int32ul,
