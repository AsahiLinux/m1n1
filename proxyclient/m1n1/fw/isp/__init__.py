...
ISPIPCBootArgs = Struct(
        ...
        "extra_iova" / Int32ul,  # 0x1824000
        "pad" / Default(Int32ul, 0),
        "extra_size" / Int32ul,  # 0x2200000
        "pad" / Default(Int32ul, 0),
...
class ISPRegs(RegMap):
	...
	ISP_ASC_POWER_CYCLE_0 = 0x1400a00, Register32  # irq mask, i think
