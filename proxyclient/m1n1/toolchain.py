...
if __name__ == "__main__":
    ...
    pprint(Toolchain())
    pprint(Toolchain(uname_result(["Linux", None, None, None, "x86_64"])))
    pprint(Toolchain(uname_result(["Linux", None, None, None, "aarch64"])))
    pprint(Toolchain(uname_result(["Darwin", None, None, None, "arm64"])))
    pprint(Toolchain(uname_result(["Darwin", None, None, None, "x86_64"])))
    pprint(Toolchain(uname_result(["OpenBSD", None, None, None, "arm64"])))
    pprint(Toolchain(uname_result(["OpenBSD", None, None, None, "amd64"])))
