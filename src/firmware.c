...
const struct fw_version_info fw_versions[NUM_FW_VERSIONS] = {
    ...
    // Same as 12.5
    // {V12_5_1, "12.5.1", {12, 5, 1}, 3, "iBoot-7459.141.1"},
    // {V12_6, "12.6", {12, 6, 0}, 3, "iBoot-7459.141.1"},
    [V12_6_1] = {V12_6_1, "12.6.1", {12, 6, 1}, 3, "iBoot-8419.41.10"},
    // Same as 12.6.1
    // {V13_0, "13.0", {13, 0, 0}, 3, "iBoot-8419.41.10"},
    [V12_6_2] = {V12_6_1, "12.6.2", {12, 6, 2}, 3, "iBoot-8419.60.44"},
    // Same as 12.6.2
    // {V13_1, "13.1", {13, 1, 0}, 3, "iBoot-8419.60.44"},
};
